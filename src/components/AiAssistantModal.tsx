    ...
    <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-md flex items-center justify-center p-2 sm:p-4 md:p-6 overflow-hidden transition-all duration-300">
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-3.5 border-b border-white/[0.06] bg-[#141417]">
          ...
          <div className="flex items-center gap-3">
            <div className="flex bg-[#16161a] p-1 rounded-xl border border-white/[0.08]">
              <button
        ...
        <div className="flex-1 overflow-hidden flex flex-col">
                      ...
                      <div className="space-y-3">
                        ...
                        {aiResult.snippets.map((snip, sIdx) => (
                          <div key={sIdx} className="bg-secondary/30 border border-border/80 rounded-xl overflow-hidden space-y-3 p-4">
                            <div className="flex items-center justify-between text-xs font-mono font-bold text-zinc-800 dark:text-zinc-200 border-b border-border/40 pb-2">
          ...
          {activeTab === 'chat' && (
            <div className="flex-1 flex flex-col h-full overflow-hidden bg-[#0f0f12] relative">
              ...
              {activeNote && (
                <div className="mx-6 mt-3 px-3.5 py-2.5 bg-[#141417] border border-white/[0.08] rounded-xl flex items-center justify-between gap-3 text-xs shrink-0">
            ...
            <div className="flex-1 flex flex-col p-4 sm:p-6 overflow-y-auto bg-background/50">
              {!blueprintResult ? (
                ...
                <div className="max-w-4xl w-full mx-auto space-y-6 my-auto">
                  ...
                  {/* Prompt Textarea */}
                  <div className="space-y-3">
                    <label className="block text-xs font-bold uppercase tracking-wider text-zinc-900 dark:text-zinc-100 flex items-center justify-between">
                      <span>Cahier des charges ou Problème à concevoir</span>
                      <span className="text-[10px] text-zinc-500 font-normal lowercase">Markdown et détails bienvenus</span>
                    </label>
                    <textarea
                      rows={5}
